...
class Wpjb_Shortcode_Map extends Wpjb_Shortcode_Abstract 
{
    ...
    public function main($atts = array()) {
        ...
        function wpjb_map_init() {
            ...
            jQuery.ajax({
              url:"https://maps.googleapis.com/maps/api/geocode/json?address="+wpjbDefaults.address+"&sensor=false<?php echo (wpjb_conf("google_api_key")) ? sprintf("&key=%s", wpjb_conf("google_api_key")) : "" ?>",
              type: "POST",
