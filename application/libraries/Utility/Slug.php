...
class Wpjb_Utility_Slug
{
    ...
    public static function generate($model, $title, $company, $id = null)
    {
        $insatnce = Wpjb_Project::getInstance();
        $slug = self::_default($model, $title, $company, $id);
    ...
    protected static function _default($model, $title, $company, $id = null)
    {   
        $list = array(
        ...
        $slug = sanitize_title($title . '-' . $company);
