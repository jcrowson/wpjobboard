    ...
    public function saveAction()
    {
        ...
        if($price == 0) {
            ...
            if(!$moderate) {
                ...
                $info[] = sprintf(__('Your job posting is now live. <a href="%s">Click here to view it</a>. To make any edits to your job posting, email hello@upmostly.com, providing the link to the job you want to edit, as well as the changes and we will update it straight away.', "wpjobboard"), $job->url());
            }
        ...
        if($payment->status == 2) {
            $cart = false;
            $info[] = __("<strong>Thank you for submitting your job listing. To make any edits to your job posting, email hello@upmostly.com, providing the link to the job you want to edit, as well as the changes and we will update it straight away.</strong>", "wpjobboard");
